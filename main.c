...
int main()
{
    ...
    */
    ...
    char secretKey[] = "abcdefghijklmnopqrafskldjfowefasdfmlsdfkjwafsdkfjlasjdfkljasdlf";
    ...
    if (german_similarity < 25)
    {
        ...
        {
            printf("\nKein passenden Schluessel gefunden, Codebrechen war nicht erfolgreich\n"
                   "Der Schluessel im Verhaeltnis zur Text Laenge ist zu hoch um den Text mit Hauefigkeitsanalyse zu brechen\n");
        }
    }
    else
    {
